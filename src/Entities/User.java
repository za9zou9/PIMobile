...
public class User {
   ...
   public User(int id, String username, String image) {
    ...
    public String toString() {
        return "User{" + "id=" + id + ", username=" + username + ", email=" + email + ", password=" + password + ", salt=" + salt + ", nom=" + nom + ", prenom=" + prenom + ", dateDeNaissance=" + dateDeNaissance + ", image=" + image + ", etat=" + etat +  ", sexe=" + sexe + ", tel=" + tel + ", age=" + age + '}';
    }
