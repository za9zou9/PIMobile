...
public class MesAmis {
    ...
    Entities.User ussr=Entities.User.getInstance();
        f = new Form("Mes Amis",new BoxLayout(BoxLayout.Y_AXIS));
   ...
   p.f.add(p.lprenom);
    ...
    AffichageCommentaire aff=new AffichageCommentaire();
     aff.getF().show();
        ...
        ArrayList<Entitiies.MesAmis> lis=serviceTask.MesAmis(ussr.getId());
        for(int i=0;i<lis.size();i++){
          
      
       
   final Entitiies.MesAmis yo=lis.get(i);
      ...
      plus=new Button("Supprimer "+lis.get(i).getPseudo()+" ");
   ...
   UserServices  us=new UserServices();
    ...
    ArrayList<Entitiies.MesAmis> lstU=us.SupprimerDe(yo.getIdMesAmis());
